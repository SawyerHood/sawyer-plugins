...
import { DelayedLoading } from "./ui/components/ui/delayed-loading";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const STYLE_MARKER = "data-bb-better-notes-styles";
const EDITOR_CSS = `
.bb-better-notes-editor .tiptap {
...
.bb-better-notes-editor .tiptap > :first-child,
.bb-better-notes-editor .tiptap li > :first-child,
.bb-better-notes-editor .tiptap blockquote > :first-child { margin-top: 0; }
.bb-better-notes-editor .tiptap p { margin: 1.25em 0 0; }
.bb-better-notes-editor .tiptap h1,
.bb-better-notes-editor .tiptap h2,
.bb-better-notes-editor .tiptap h3,
.bb-better-notes-editor .tiptap h4,
.bb-better-notes-editor .tiptap h5,
.bb-better-notes-editor .tiptap h6 { margin-bottom: 0; color: var(--foreground); font-weight: 600; }
.bb-better-notes-editor .tiptap h1 { font-size: 1.75em; line-height: 1.3; margin-top: 1.25em; }
.bb-better-notes-editor .tiptap h2 { font-size: 1.25em; line-height: 1.4; margin-top: 1.75em; }
.bb-better-notes-editor .tiptap h3 { font-size: 1.125em; line-height: 1.45; margin-top: 1.25em; }
.bb-better-notes-editor .tiptap h4 { font-size: 1em; line-height: 1.5; margin-top: 1.25em; }
.bb-better-notes-editor .tiptap h5 { font-size: 0.875em; line-height: 1.5; font-weight: 500; color: var(--muted-foreground); margin-top: 1.43em; }
.bb-better-notes-editor .tiptap h6 { font-size: 0.8125em; line-height: 1.5; font-weight: 500; letter-spacing: 0.08em; text-transform: uppercase; color: var(--muted-foreground); margin-top: 1.54em; }
.bb-better-notes-editor .tiptap :is(h1, h2, h3, h4, h5, h6) + * { margin-top: 1em; }
.bb-better-notes-editor .tiptap ul, .bb-better-notes-editor .tiptap ol { margin: 1.25em 0 0; padding-left: 1.5em; }
.bb-better-notes-editor .tiptap ul { list-style: disc; }
.bb-better-notes-editor .tiptap ol { list-style: decimal; }
.bb-better-notes-editor .tiptap li { margin-top: 0.5em; padding-left: 0.4em; }
.bb-better-notes-editor .tiptap li > p, .bb-better-notes-editor .tiptap li > ul, .bb-better-notes-editor .tiptap li > ol { margin-top: 0.5em; }
.bb-better-notes-editor .tiptap li::marker { color: var(--muted-foreground); }
.bb-better-notes-editor .tiptap a { color: inherit; font-weight: 500; text-decoration: underline; text-decoration-color: color-mix(in oklab, currentColor 30%, transparent); cursor: pointer; }
.bb-better-notes-editor .tiptap a:hover { text-decoration-color: currentColor; }
.bb-better-notes-editor .tiptap a:focus-visible { outline: 2px solid var(--ring); outline-offset: 2px; border-radius: 0.125em; }
.bb-better-notes-editor .tiptap strong { font-weight: 600; }
.bb-better-notes-editor .tiptap code { background: var(--muted); border-radius: min(calc(var(--radius) * 0.6), 0.35em); padding: 0.125em 0.3em; font-size: 0.85em; font-family: var(--font-mono, ui-monospace, SFMono-Regular, Menlo, Consolas, monospace); }
.bb-better-notes-editor .tiptap pre { background: var(--muted); border-radius: var(--radius); padding: 0.75em 1em; overflow-x: auto; font-size: 0.875em; line-height: 1.5; margin: 1.43em 0 0; tab-size: 2; }
.bb-better-notes-editor .tiptap pre code { background: none; padding: 0; font-size: inherit; }
.bb-better-notes-editor .tiptap blockquote { border-left: 2px solid var(--border); padding-left: 1em; margin: 1.25em 0 0; }
.bb-better-notes-editor .tiptap hr { border: none; border-top: 1px solid var(--border); margin: 3em 0 0; }
.bb-better-notes-editor .tiptap hr + :is(h1, h2, h3, h4) { margin-top: 1.25em; }
.bb-better-notes-editor .tiptap img { display: block; max-width: 100%; max-height: 38rem; margin: 1.5em auto 0; border-radius: var(--radius); border: 1px solid var(--border); }
.bb-better-notes-editor .tiptap .tableWrapper { margin: 1.5em 0 0; overflow-x: auto; }
.bb-better-notes-editor .tiptap table { width: 100%; border-collapse: collapse; table-layout: fixed; }
.bb-better-notes-editor .tiptap th,
.bb-better-notes-editor .tiptap td { position: relative; min-width: 6rem; border: 1px solid var(--border); padding: 0.5em 0.65em; text-align: left; vertical-align: top; }
.bb-better-notes-editor .tiptap th { background: var(--muted); font-weight: 600; }
.bb-better-notes-editor .tiptap :is(th, td) > p { margin-top: 0; }
.bb-better-notes-editor .tiptap :is(th, td) > p + p { margin-top: 0.65em; }
.bb-better-notes-editor .tiptap .selectedCell::after { position: absolute; inset: 0; z-index: 2; pointer-events: none; content: ""; background: color-mix(in oklab, var(--primary) 14%, transparent); }
.bb-better-notes-editor .tiptap .column-resize-handle { position: absolute; top: 0; right: -2px; bottom: -1px; width: 4px; z-index: 3; pointer-events: none; background: var(--primary); }
.bb-better-notes-editor .tiptap.resize-cursor { cursor: col-resize; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] { list-style: none; padding-left: 0.25em; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] ul[data-type="taskList"] { margin-top: 0; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] li { display: flex; align-items: flex-start; gap: 0.5em; margin-top: 0.5em; padding-left: 0; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] li > label { flex: 0 0 auto; display: inline-flex; align-items: center; height: 1.7em; user-select: none; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] li > div { flex: 1 1 auto; min-width: 0; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] li > div > p { line-height: 1.75; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] li > div > p:first-child { margin-top: 0; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] input[type="checkbox"] { display: block; width: 15px; height: 15px; accent-color: var(--primary); cursor: pointer; margin: 0; }
.bb-better-notes-editor .tiptap ul[data-type="taskList"] li[data-checked="true"] > div { color: var(--muted-foreground); text-decoration: line-through; }
.bb-better-notes-editor .tiptap p.is-editor-empty:first-child::before { content: attr(data-placeholder); float: left; height: 0; pointer-events: none; color: var(--muted-foreground); }
.bb-better-notes-editor .tiptap ::selection { background: color-mix(in oklab, var(--primary) 22%, transparent); }
...
.bb-better-notes-panel .tiptap { max-width: none; padding: 1rem 0 3rem; font-size: 14px; }
@media (max-width: 47.999rem) { .bb-better-notes-editor .tiptap { padding-inline: 1.25rem; font-size: 16.875px; } }
`;
...
function TiptapEditor({
  ...
  return (
    <div
      ref={rootRef}
      className="bb-better-notes-editor min-h-0 flex-1 overflow-y-auto"
    />
  );
}
...
function useNotebook(vaultId: string | null) {
  ...
  const consumerRef = useRef(Symbol("better-notes-notebook-consumer"));
  ...
  if (!document) {
    return (
      <div className="my-3 rounded-lg border border-destructive/40 bg-destructive/5 p-3 text-sm text-destructive">
        Invalid Better Notes link. Expected a vault and a Markdown or HTML path.
      </div>
    );
  }
  const openInDocs = () =>
    navigate.toPluginPanel("better-notes", {
  ...
  return (
    <div className="my-3 flex h-11 items-center gap-1 rounded-lg border border-border bg-card px-2 shadow-sm transition-colors hover:bg-state-hover">
      ...
      <Button
        ...
        size="icon"
        variant="ghost"
        aria-label="Open in Better Notes"
        onClick={openInDocs}
      >
  ...
  if (!document)
    return (
      <div className="text-sm text-muted-foreground">
        Open a Better Notes card from a message to edit it here.
      </div>
    );
  return (
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-1 flex-col">
      ...
      <TiptapEditor
        ...
        onUpload={async () => {
          throw new Error(
            "Add this file to a Better Notes vault before uploading images",
          );
        }}
        onFirstRender={(markdown) => {
          markdownRef.current = markdown;
...
const LAST_DOCUMENT_KEY = "bb:better-notes:last-document";
...
function NotesWorkspace({
  ...
  useEffect(() => {
    // Only the main panel owns navigation; the sidebar mounts separately.
    if (navigationOnly) return;
    try {
      if (subPath) {
        restoredRef.current = false;
        if (route.vaultId && route.filePath) {
          localStorage.setItem(LAST_DOCUMENT_KEY, subPath);
        } else {
      ...
      const saved = localStorage.getItem(LAST_DOCUMENT_KEY);
      if (!saved) return;
      const previous = parseRoute(saved);
      if (previous.vaultId && previous.filePath && /\.(md|html?)$/i.test(previous.filePath)) {
        navigate.toPluginPanel("better-notes", { subPath: saved, replace: true });
      }
    } catch {
      // Browsing still works when storage is unavailable or malformed.
    }
  }, [navigationOnly, subPath, route.vaultId, route.filePath, navigate]);
...
export default definePluginApp((app) => {
  ...
  app.slots.messageDirective({ id: "better-notes", component: DocsDirectiveCard });
});
