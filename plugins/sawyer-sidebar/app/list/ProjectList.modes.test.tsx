...
import {
  makeThreadListEntry,
} from "../../vendor/test-helpers/domain-fixtures.js";
import { sdkResult, toPluginSidebarThread } from "../model/fixtures.js";

vi.mock("../../vendor/client-core/sidebar/machineThreadGroups.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../vendor/client-core/sidebar/machineThreadGroups.js")>();
  return {
    ...actual,
